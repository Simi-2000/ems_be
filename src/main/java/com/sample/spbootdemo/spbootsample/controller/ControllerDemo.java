...
public class ControllerDemo {
	...
	@GetMapping("one")
	public ResponseEntity<StudentModel> viewOneStudent(@RequestParam Integer studentRollNo) {
		return new ResponseEntity<>(service.viewOneStudent(studentRollNo), HttpStatus.OK);
	}
	...
	public ResponseEntity<String> deleteStudent(@RequestParam Integer studentRollNo) {
		boolean isDeleted = service.deleteStudent(studentRollNo);
		if (isDeleted) {
